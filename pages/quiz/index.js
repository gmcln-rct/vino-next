...
export default function ResourcesIndex({ topGrapes }) {
  return (
    <>
      <Head>
        <title>Wine Quiz Index - Winography | Learn About Wine Through Data Visualizations</title>
        <meta
          name="description"
      ...
      <section className="info">
        ...
        <h3 className="subheader">Think you&apos;re a wine whiz? Prove your grape smarts in 10 questions.</h3>
