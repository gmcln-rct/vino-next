...
function AboutPage() {
  return (
    <section className="aboutPage">
      ...
      <p>The site was was created by New York-based Front End Developer <Link href="https://www.glennmcclanan.com/">Glenn McClanan</Link> using <Link href="https://nextjs.org/">Next.js</Link> and <Link href="https://d3js.org/">D3</Link>.</p>
      <p>
